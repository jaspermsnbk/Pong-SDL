...
public:
	int player1Score;
	int player2Score;
	std::vector<SDL_Rect> * num_0 = new std::vector<SDL_Rect>({ {0,0,5,1}, {0,0,1,10}, {0,9,5,1}, {4,0,1,10} });
	std::vector<SDL_Rect> * num_1 = new std::vector<SDL_Rect>({ {2,0,1,10} });
	std::vector<SDL_Rect> * num_2 = new std::vector<SDL_Rect>({ {0,0,5,1}, {0,4,5,1}, {0,9,5,1}, {4,0,1,5}, {0,5,1,5}});
	std::vector<SDL_Rect> * num_3 = new std::vector<SDL_Rect>({ {0,0,5,1}, {0,4,5,1}, {0,9,5,1}, {4,0,1,10} });
